...

{
  ...
  programs.fish = {
    ...
    shellAliases = {
      ...
      ros = "xhost +; docker run $argv --mount source=cargo-cache,target=/home/casper/.cargo --cap-add=SYS_PTRACE -e DISPLAY=$DISPLAY --device /dev/dri -v /tmp/.X11-unix:/tmp/.X11-unix -v $HOME/.Xauthority:/home/casper/.Xauthority -v $PWD:/pwd --rm -it ros:melodic-custom; echo > /dev/null";
